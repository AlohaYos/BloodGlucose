...
@objcMembers open class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
	...
	@objc public override func setChartData(_ dataToSet: ChartData)
	{
		_data = dataToSet
	}
